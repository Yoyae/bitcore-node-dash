...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --daemon', 'Make bitcore-node-monoeci a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bitcore-node-monoeci create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bitcore-node-monoeci add wallet-service');
      console.log('    $ bitcore-node-monoeci add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bitcore-node-monoeci remove wallet-service');
      console.log('    $ bitcore-node-monoeci remove insight-api');
      console.log();
    });
